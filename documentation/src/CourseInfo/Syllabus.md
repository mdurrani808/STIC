...
This course pulls material heavily from "The Missing Semester of Your CS Education" from MIT and Anish Athalye, Jon Gjengset, Jose Javier Ortiz. The materials follow the license as specified by [CC BY-NC-SA](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.en), as detailed [here](https://github.com/missing-semester/missing-semester/tree/master?tab=readme-ov-file#license).
